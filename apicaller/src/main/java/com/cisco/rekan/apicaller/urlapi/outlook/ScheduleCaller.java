 ...
 *
 */
public class ScheduleCaller extends AbstractURLAPICaller {
    ...
    protected void addFixedParams() {
        ...
        // email template
        super.addParam("EmailTemplateType", "TEXT");
    ...
    protected void setEndCalendar(final Calendar endCal) {
        super.addParam("UntilYE", endCal.get(Calendar.YEAR));
        super.addParam("UntilMO", endCal.get(Calendar.MONTH) + 1);
        super.addParam("UntilDA", endCal.get(Calendar.DAY_OF_MONTH));
        super.addParam("UntilHour", endCal.get(Calendar.HOUR_OF_DAY));
        super.addParam("UntilMin", endCal.get(Calendar.MINUTE));
        super.addParam("UntilSec", endCal.get(Calendar.SECOND));
    }
    ...
    protected void addRepeatedParams4Daily() {
        ...
        endCal.add(Calendar.MINUTE, meetingDuration);
    ...
    public static String scheduleKillersSeries4PC(String userName, String userPlainPassword, String meetingTopic) {
        ScheduleCaller caller = new ScheduleCaller();
