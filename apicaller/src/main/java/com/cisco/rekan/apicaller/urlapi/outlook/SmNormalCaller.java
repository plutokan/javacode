 ...
 *
 */
public class SmNormalCaller extends AbstractURLAPICaller {
     ...
     * @return
     */
    public static String schedule(String userName, String userPlainPassword, String meetingTopic) {
        SmNormalCaller caller = new SmNormalCaller();

        caller.addParam("MT", String.valueOf(Constants.MEETING_TYPE_ID_PRO_DEFAULT));
        caller.addParam("OA", "190"); // site and user priviledge(bit) 
        caller.addDateInfo();
    ...
    public void test() {
        ...
        String userPlainPassword = "P@ss1234";
        String meetingTopic = "PlutoTestMeeting 010";

        schedule(userName, userPlainPassword, meetingTopic);
    }
